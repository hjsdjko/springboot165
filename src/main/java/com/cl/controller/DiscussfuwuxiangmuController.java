...
public class DiscussfuwuxiangmuController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		discussfuwuxiangmu = discussfuwuxiangmuService.selectView(new EntityWrapper<DiscussfuwuxiangmuEntity>().eq("id", id));
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussfuwuxiangmuEntity discussfuwuxiangmu, HttpServletRequest request,String pre){
        EntityWrapper<DiscussfuwuxiangmuEntity> ew = new EntityWrapper<DiscussfuwuxiangmuEntity>();
